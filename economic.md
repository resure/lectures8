...
- Национальный доход (НД). Существует разница между ценами, по которым покупают товары потребители и ценами реализации фирм. Эта разница представляет собой косвенные налоги. `НД = ТНП - КН`
